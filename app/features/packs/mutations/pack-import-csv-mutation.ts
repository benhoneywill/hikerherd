...
import getNextPackCategoryIndex from "app/features/pack-categories/functions/get-next-pack-category-index";
import getNextPackItemIndex from "app/features/pack-gear/functions/get-next-pack-item-index";
import createPackGear from "app/features/pack-gear/functions/create-pack-gear";
